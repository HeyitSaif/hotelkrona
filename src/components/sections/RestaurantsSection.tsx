    ...
    <section className="py-24 md:py-32 bg-white relative overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-base md:text-lg text-bronze-dark leading-relaxed">
          ...
          >
            ...
            <div className="p-8 md:p-12">
              <div className="flex items-center gap-3 mb-6">
                ...
                <p className="text-xs text-gold-darker uppercase tracking-widest font-bold">
                  Elegant European-Russian Cuisine
                </p>
              </div>
              <h3 className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold text-deep-bronze mb-6">
                Romanov Restaurant
              </h3>
              <p className="text-bronze-dark leading-relaxed text-base mb-4">
                Step into the refined atmosphere of Romanov, where classical European sophistication meets authentic Russian heritage.
              </p>
              <p className="text-bronze-dark leading-relaxed text-base">
